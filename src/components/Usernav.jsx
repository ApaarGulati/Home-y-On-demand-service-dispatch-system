    ...
    return (
        <nav className="bg-transparent px-6 py-4">
            <div className="flex flex-row items-center justify-between max-w-7xl mx-auto">
                ...
                {/* Logo Placeholder */}
                <div className="w-40 text-cyan-500 font-black text-2xl cursor-pointer" onClick={() => navigate("/home")}>
                ...
                <div className="hidden md:flex flex-row items-center gap-10">
                    {navLinks.map((link) => (
                        <div
                            ...
                            className={`cursor-pointer text-[14px] transition-all duration-300 pb-1 ${activeTab === link
            ...
            {/* Mobile Menu */}
            <div className={`${isOpen ? 'max-h-70 opacity-100' : 'max-h-0 opacity-0'} md:hidden overflow-hidden transition-all duration-300 ease-in-out`}>
                <div className="flex flex-col gap-4 mt-4 pb-4">
                    {navLinks.map((link) => (
                        <div
                            ...
                            className={`text-base py-2 cursor-pointer transition-all ${activeTab === link
