    ...
    return (
      <nav className="bg-transparent px-6 py-4">
        <div className="flex flex-row items-center justify-between max-w-7xl mx-auto">
          ...
          {!(user_role==null)?<button className="hidden md:block bg-cyan-500 px-6 py-2 text-white rounded-full font-bold text-[12px] hover:bg-cyan-700 transition-colors cursor-pointer" onClick={handleLogout}>Logout</button>:<button className='hidden md:block bg-cyan-500 px-6 py-2 text-white rounded-full font-bold text-[12px] hover:bg-cyan-700 transition-colors cursor-pointer' onClick={()=>navigate("/login")}>Login</button>}
            {/* Mobile Toggle */}
            <button
        ...
        >
          <div className="flex flex-col gap-4 mt-4 pb-4">
            ...
            {!(user_role==null)?<button className="bg-cyan-500 text-white py-2 rounded-full font-bold text-sm" onClick={handleLogout}>Logout</button>:<button className="bg-cyan-500 text-white py-2 rounded-full font-bold text-sm" onClick={()=>navigate("/login")}>Login</button>}
          </div>
        </div>
      </nav>
    );
