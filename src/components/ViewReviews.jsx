        ...
        <div className="min-h-screen bg-gray-50 py-10 px-4 md:px-10">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="grid grid-cols-1 gap-4">
                    {reviews.map((review) => (
                        <div key={review.id} className="bg-white border border-gray-200 rounded-2xl p-6 transition-all hover:border-cyan-300 hover:shadow-sm">
                            <div className="flex justify-between items-start mb-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="font-bold text-gray-900 leading-tight">{review.customerName}</h3>
                            ...
                            {/* Service Tag */}
                            <div className="inline-block bg-cyan-50 text-cyan-700 text-[10px] font-black uppercase px-2 py-1 rounded-md mb-3">
                                {review.serviceName}
                            </div>

                            {/* Comment Section */}
                            {review.comment ? (
                                <div className="flex gap-3 text-gray-700 italic text-[14px] bg-gray-50 p-4 rounded-xl border-l-4 border-cyan-500">
